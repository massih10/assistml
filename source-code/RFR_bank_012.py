...
lr = Pipeline([
    ...
    ('classifier', ExtraTreesClassifier(n_estimators=25,max_depth=5))])
...
import joblib
filename = '/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_012.pkl'
...
if os.path.exists('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_012.json'):
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_012.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_012.json', 'w') as f:
