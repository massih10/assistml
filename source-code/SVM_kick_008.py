...
sv = SVC(C=1.0, kernel='poly', degree=50, gamma='scale', cache_size=2000, coef0=0.001, probability=True, random_state=seed)
...
import joblib
filename = '/home/sruthi/asm-2/asm-2/3_pickle/SVM_kick_008.pkl'
...
print(metrics)
import os,json
if os.path.exists('/home/sruthi/asm-2/asm-2/3_pickle/SVM_kick_008.json'):
    with open('/home/sruthi/asm-2/asm-2/3_pickle/SVM_kick_008.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/sruthi/asm-2/asm-2/3_pickle/SVM_kick_008.json', 'w') as f:
