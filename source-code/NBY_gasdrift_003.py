...
df = pd.read_csv('/home/mohammoa/gasdriftnormalized3.csv', na_values=missing_values)
...
anova_filter = SelectKBest(f_classif, k=39)
dt = CategoricalNB()
...
filename = '/home/mohammoa/HiWi/asm-2/3_pickle/NBY_gasdrift_003.pkl'
...
if os.path.exists('/home/mohammoa/HiWi/asm-2/3_pickle/NBY_gasdrift_003.json'):
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/NBY_gasdrift_003.json', 'r') as f:
        models = json.load(f)
    models["NBY_gasdrift_003"]["Metrics"] = metrics
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/NBY_gasdrift_003.json', 'w') as f:
