...
lr = Pipeline([
    ...
    ('classifier', RandomForestClassifier(n_estimators=20,max_depth=10,min_samples_split=2))])
...
import joblib
filename = '/home/sruthi/asm-2/3_pickle/RFR_bank_033.pkl'
...
if os.path.exists('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_033.json'):
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_033.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_033.json', 'w') as f:
