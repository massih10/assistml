...
lr = Pipeline([
    ...
    ('classifier', ExtraTreesClassifier(min_weight_fraction_leaf=0))])
...
import joblib
filename = '/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_008.pkl'
...
if os.path.exists('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_008.json'):
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_008.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_008.json', 'w') as f:
