...
filename = '/home/mohammoa/HiWi/asm-2/3_pickle/KNN_gasdrift_001.pkl'
...
if os.path.exists('/home/mohammoa/HiWi/asm-2/3_pickle/KNN_gasdrift_001.json'):
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/KNN_gasdrift_001.json', 'r') as f:
        models = json.load(f)
    models["NBY_gasdrift_001"]["Metrics"] = metrics
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/KNN_gasdrift_001.json', 'w') as f:
