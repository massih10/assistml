...
import joblib
filename = '/home/mohammoa/HiWi/asm-2/3_pickle/RFR_kick_010.pkl'
...
if os.path.exists('/home/mohammoa/HiWi/asm-2/3_pickle/RFR_kick_010.json'):
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/RFR_kick_010.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/RFR_kick_010.json', 'w') as f:
