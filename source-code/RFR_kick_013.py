...
dt = ExtraTreesClassifier(n_estimators=15,max_depth=5)
seed = 25
y = df.IsBadBuy
...
import joblib
filename = '/home/sruthi/asm-2/asm-2/3_pickle/RFR_kick_013.pkl'
...
if os.path.exists('/home/sruthi/asm-2/asm-2/3_pickle/RFR_kick_013.json'):
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_kick_013.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_kick_013.json', 'w') as f:
