...
lr = Pipeline([
    ...
    ('classifier', ExtraTreesClassifier(n_estimators=5,max_depth=5))])
...
import joblib
filename = '/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_004.pkl'
...
metrics['Test_File'] = "bank_stratified_test_25.csv"
...
if os.path.exists('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_004.json'):
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_004.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_004.json', 'w') as f:
