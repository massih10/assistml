...
dt = RandomForestClassifier(n_estimators=20,max_depth=10)
seed = 25
y = df.IsBadBuy
...
import joblib
filename = '/home/mohammoa/HiWi/asm-2/3_pickle/RFR_kick_032.pkl'
...
if os.path.exists('/home/mohammoa/HiWi/asm-2/3_pickle/RFR_kick_032.json'):
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/RFR_kick_032.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/RFR_kick_032.json', 'w') as f:
