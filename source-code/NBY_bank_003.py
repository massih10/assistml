...
if __name__ == "__main__":
    ...
    test_csv_name = "bank_test_" + str(int((1 - train_size) * 100)) + ".csv"
    ...
    pickle_file_name = "NBY_bank_003"  # No need to put .pkl extension. pycaret save model automatically puts .pkl extension
    ...
    json_file_name = "NBY_bank_003.json"
