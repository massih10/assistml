...
filename = '/home/mohammoa/HiWi/asm-2/3_pickle/DTR_adult_002.pkl'
...
metrics["Test_File"] = "adult_stratified_onehot_test_25.csv"
...
if os.path.exists('/home/mohammoa/HiWi/asm-2/3_pickle/DTR_adult_002.json'):
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/DTR_adult_002.json', 'r') as f:
        models = json.load(f)
    models["Model"]["Metrics"] = metrics
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/DTR_adult_002.json', 'w') as f:
