...
print(metrics)
# import os,json
# if os.path.exists('/home/sruthi/asm-2/asm-2/3_pickle/SVM_kick_010.json'):
#     with open('/home/sruthi/asm-2/asm-2/3_pickle/SVM_kick_010.json', 'r') as f:
#         models = json.load(f)
#     models["Metrics"] = metrics
#     with open('/home/sruthi/asm-2/asm-2/3_pickle/SVM_kick_00.json', 'w') as f:
