...
model_bank = H2ORandomForestEstimator(ntrees = 100, seed =25, nfolds=5, max_depth=20,balance_classes=True)   ## Instantiating the class
...
import os,json
if os.path.exists('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_018.json'):
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_018.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_018.json', 'w') as f:
