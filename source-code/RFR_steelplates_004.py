...
dt = ExtraTreesClassifier(n_estimators=20,max_depth=25)
seed = 25
y = df.target
...
print(test_df)
test_df.to_csv('/home/osama/HiWi/new-version/asm-2/1_data/steelplates_test_25_25.csv', index=False, header=True)
...
filename = '/home/osama/HiWi/new-version/asm-2/3_pickle/RFR_steelplates_004.pkl'
...
if os.path.exists('/home/osama/HiWi/new-version/asm-2/3_pickle/RFR_steelplates_004.json'):
    with open('/home/osama/HiWi/new-version/asm-2/3_pickle/RFR_steelplates_004.json', 'r') as f:
        models = json.load(f)
    models["Model"]["Metrics"] = metrics
    with open('/home/osama/HiWi/new-version/asm-2/3_pickle/RFR_steelplates_004.json', 'w') as f:
