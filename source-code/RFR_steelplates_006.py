...
dt = ExtraTreesClassifier(n_estimators=20,max_depth=20)
seed = 25
y = df.target
...
filename = '/home/osama/HiWi/new-version/asm-2/3_pickle/RFR_steelplates_006.pkl'
...
if os.path.exists('/home/osama/HiWi/new-version/asm-2/3_pickle/RFR_steelplates_006.json'):
    with open('/home/osama/HiWi/new-version/asm-2/3_pickle/RFR_steelplates_006.json', 'r') as f:
        models = json.load(f)
    models["Model"]["Metrics"] = metrics
    with open('/home/osama/HiWi/new-version/asm-2/3_pickle/RFR_steelplates_006.json', 'w') as f:
