...
df = pd.read_csv('/home/mohammoa/HiWi/asm-2/1_data/kick.csv',na_values=missing_values)
...
print(test_df)
test_df.to_csv('/home/mohammoa/HiWi/asm-2/1_data/kick_test_25_25.csv', index=False, header=True)
...
import joblib
filename = '/home/mohammoa/HiWi/asm-2/3_pickle/RFR_kick_028.pkl'
...
if os.path.exists('/home/mohammoa/HiWi/asm-2/3_pickle/RFR_kick_028.json'):
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/RFR_kick_028.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/RFR_kick_028.json', 'w') as f:
