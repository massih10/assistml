...
df = pd.read_csv('/home/mohammoa/gasdriftnormalized2.csv', na_values=missing_values)
...
filename = '/home/mohammoa/HiWi/asm-2/3_pickle/NBY_gasdrift_002.pkl'
...
if os.path.exists('/home/mohammoa/HiWi/asm-2/3_pickle/NBY_gasdrift_002.json'):
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/NBY_gasdrift_002.json', 'r') as f:
        models = json.load(f)
    models["NBY_gasdrift_002"]["Metrics"] = metrics
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/NBY_gasdrift_002.json', 'w') as f:
