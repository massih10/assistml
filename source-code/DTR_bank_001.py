...
import joblib
filename = '/home/mohammoa/HiWi/asm-2/3_pickle/DTR_bank_001.pkl'
...
metrics["Test_time_per_unit"] = t2/24867
metrics["Confusion_Matrix_rowstrue_colspred"] = d
metrics["Test_File"] = "kick_stratified_onehot_test_55.csv"
print("Score= {}".format(s))
print("Error= {}".format(1-s))
print("Precision,Recall,F_beta,Support {}".format(prec_recall))
print(confusion_matrix(y_test,y_pred))
print("test time per unit",(t2/24867))

import json
import os

if os.path.exists('/home/mohammoa/HiWi/asm-2/3_pickle/DTR_bank_001.json'):
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/DTR_bank_001.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/DTR_bank_001.json', 'w') as f:
