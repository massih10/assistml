...
dt = Pipeline([
    ...
    ('classifier', DecisionTreeClassifier(random_state=0,min_impurity_decrease=0.01))])
...
import joblib
filename = '/home/sruthi/asm-2/asm-2/3_pickle/DTR_kick_008.pkl'
...
print("test time per unit",(t/17450))
