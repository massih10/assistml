...
lr = Pipeline([
    ...
    ('classifier', DecisionTreeClassifier(min_impurity_decrease=0.1))])
...
import joblib
filename = '/home/sruthi/asm-2/asm-2/3_pickle/DTR_bank_017.pkl'
...
if os.path.exists('/home/sruthi/asm-2/asm-2/3_pickle/DTR_bank_017.json'):
    with open('/home/sruthi/asm-2/asm-2/3_pickle/DTR_bank_017.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/sruthi/asm-2/asm-2/3_pickle/DTR_bank_017.json', 'w') as f:
