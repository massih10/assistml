...
import joblib
filename = '/home/mohammoa/HiWi/asm-2/3_pickle/NBY_kick_003.pkl'
...
if os.path.exists('/home/mohammoa/HiWi/asm-2/3_pickle/NBY_kick_003.json'):
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/NBY_kick_003.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/NBY_kick_003.json', 'w') as f:
