...
lr = Pipeline([
    ...
    ('classifier', ExtraTreesClassifier(n_estimators=20,max_depth=15))])
...
import joblib
filename = '/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_016.pkl'
...
if os.path.exists('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_016.json'):
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_016.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_016.json', 'w') as f:
