...
dt = RandomForestClassifier(n_estimators=30)
seed = 25
y = df.IsBadBuy
...
import joblib
filename = '/home/mohammoa/HiWi/asm-2/3_pickle/RFR_kick_030.pkl'
...
if os.path.exists('/home/mohammoa/HiWi/asm-2/3_pickle/RFR_kick_030.json'):
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/RFR_kick_030.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/RFR_kick_030.json', 'w') as f:
