...
lr = Pipeline([
    ...
    ('classifier', DecisionTreeClassifier(min_impurity_decrease=0.0001))])
...
import joblib
filename = '/home/sruthi/asm-2/asm-2/3_pickle/DTR_bank_007.pkl'
...
if os.path.exists('/home/sruthi/asm-2/asm-2/3_pickle/DTR_bank_007.json'):
    with open('/home/sruthi/asm-2/asm-2/3_pickle/DTR_bank_007.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/sruthi/asm-2/asm-2/3_pickle/DTR_bank_007.json', 'w') as f:
