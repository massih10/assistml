...
data_train_all = h2o.import_file("/home/mohammoa/HiWi/asm-2/1_data/steelplates_train_75.csv")
data_train_all['target'] = data_train_all['target'].asfactor()
...
data_test_all=h2o.import_file("/home/mohammoa/HiWi/asm-2/1_data/steelplates_test_25.csv")
data_test_all['target'] = data_test_all['target'].asfactor()
...
model_bank = H2ODeepLearningEstimator(hidden = [10,10,10,10,10],balance_classes = True,epochs = 2,nfolds = 5, fold_assignment = 'Stratified',l1 = 0.01, mini_batch_size = 100, input_dropout_ratio = 0.1, seed = 25, standardize = True)
start=time.time()
model_bank.train(x=x,y=y, training_frame=data_train_all, model_id="DLN_steelplates_001")
end=time.time()
t=(end-start)

modelfile = model_bank.download_mojo(path="/home/mohammoa/HiWi/asm-2/3_pickle", get_genmodel_jar=True)
...
import os,json
if os.path.exists('/home/mohammoa/HiWi/asm-2/3_pickle/DLN_steelplates_001.json'):
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/DLN_steelplates_001.json', 'r') as f:
        models = json.load(f)
    models["Model"]["Metrics"] = metrics
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/DLN_steelplates_001.json', 'w') as f:
