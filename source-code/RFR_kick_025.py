...
dt = RandomForestClassifier(n_estimators=5)
seed = 25
y = df.IsBadBuy
...
import joblib
filename = '/home/sruthi/asm-2/asm-2/3_pickle/RFR_kick_025.pkl'
...
if os.path.exists('/home/sruthi/asm-2/asm-2/3_pickle/RFR_kick_025.json'):
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_kick_025.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_kick_025.json', 'w') as f:
