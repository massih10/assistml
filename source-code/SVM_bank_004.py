...
lr = Pipeline([
    ...
    ('classifier', LinearSVC(penalty='l2',loss='squared_hinge', dual=True, tol=0.0001, C=0.01, multi_class='ovr', fit_intercept=True, intercept_scaling=1, class_weight=None, verbose=0, random_state=seed, max_iter=2000))])
...
import joblib
filename = '/home/sruthi/asm-2/asm-2/3_pickle/SVM_bank_004.pkl'
...
# import os,json
# if os.path.exists('/home/sruthi/asm-2/asm-2/3_pickle/SVM_bank_004.json'):
#     with open('/home/sruthi/asm-2/asm-2/3_pickle/SVM_bank_004.json', 'r') as f:
#         models = json.load(f)
#     models["Metrics"] = metrics
#     with open('/home/sruthi/asm-2/asm-2/3_pickle/SVM_bank_004.json', 'w') as f:
