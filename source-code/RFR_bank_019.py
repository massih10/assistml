...
model_bank = H2ORandomForestEstimator(ntrees = 50, seed =25, nfolds=5, max_depth=10,balance_classes=True)   ## Instantiating the class
...
import os,json
if os.path.exists('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_019.json'):
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_019.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_019.json', 'w') as f:
