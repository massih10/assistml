...
categorical_columns = ['Color','WheelTypeID','Auction','Transmission','WheelType','TopThreeAmericanName','IsOnlineSale']
...
preprocess = ColumnTransformer(transformers=[('cat', categorical_pipe, ordinal_column),('cat1',categorical_pipe_1,categorical_columns),('num', numerical_pipe, numerical_columns)])
...
import joblib
filename = '/home/sruthi/asm-2/3_pickle/DTR_kick_005.pkl'
...
pl = preprocess.named_transformers_['cat1']
ohe = pl.named_steps['Hashing']
