...
lr = Pipeline([
    ...
    ('classifier', LogisticRegression(penalty='l2', dual=False, C=0.001, max_iter=1000, fit_intercept=True, intercept_scaling=1, class_weight=None, random_state=None, solver='newton-cg', multi_class='auto', verbose=0, warm_start=False, n_jobs=None, l1_ratio=None))])
...
import joblib
filename = '/home/sruthi/asm-2/asm-2/3_pickle/LGR_bank_012.pkl'
