...
df = pd.read_csv('/home/mohammoa/HiWi/asm-2/1_data/adult_1590.csv', na_values=missing_values)
...
filename = '/home/mohammoa/HiWi/asm-2/3_pickle/RFR_adult_002.pkl'
...
metrics['Test_time_per_unit'] = t / 24865
metrics["Confusion_Matrix_rowstrue_colspred"] = d
metrics['Test_File'] = "adult_upsampled_onehot_test_25.csv"
test_dataset.to_csv('/home/mohammoa/HiWi/asm-2/3_pickle/adult_upsampled_onehot_test_25.csv')
...
if os.path.exists('/home/mohammoa/HiWi/asm-2/3_pickle/RFR_adult_002.json'):
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/RFR_adult_002.json', 'r') as f:
        models = json.load(f)
    models["Model"]["Metrics"] = metrics
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/RFR_adult_002.json', 'w') as f:
