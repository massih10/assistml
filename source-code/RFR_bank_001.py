...
print(test_df)
test_df.to_csv('/home/mohammoa/HiWi/asm-2/1_data/bank_test_25_25.csv', index=False, header=True)
...
import joblib
filename = '/home/mohammoa/HiWi/asm-2/3_pickle/RFR_bank_001.pkl'
...
metrics['Test_File'] = "bank_upsampled_onehot_test_25.csv"
...
if os.path.exists('/home/mohammoa/HiWi/asm-2/3_pickle/RFR_bank_001.json'):
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/RFR_bank_001.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/RFR_bank_001.json', 'w') as f:
