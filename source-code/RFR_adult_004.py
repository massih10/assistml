...
filename = '/home/mohammoa/HiWi/asm-2/3_pickle/RFR_adult_004.pkl'
...
if os.path.exists('/home/mohammoa/HiWi/asm-2/3_pickle/RFR_adult_004.json'):
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/RFR_adult_004.json', 'r') as f:
        models = json.load(f)
    models["Model"]["Metrics"] = metrics
    with open('/home/mohammoa/HiWi/asm-2/3_pickle/RFR_adult_004.json', 'w') as f:
