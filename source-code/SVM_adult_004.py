...
if __name__ == "__main__":
    ...
    alpha = tuned_SVM_clf.alpha
    hyper_parameters_dict["alpha"] = str(alpha)
    hyper_parameters_dict["eta0"] = str(tuned_SVM_clf.eta0)
    ...
    pickle_file_name = "SVM_adult_004"  # No need to put .pkl extension. pycaret save model automatically puts .pkl extension
    ...
    json_file_name = "SVM_adult_004.json"
