...
lr = Pipeline([
    ...
    ('classifier', ExtraTreesClassifier(n_estimators=20,max_depth=25))])
...
import joblib
filename = '/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_006.pkl'
...
if os.path.exists('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_006.json'):
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_006.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_006.json', 'w') as f:
