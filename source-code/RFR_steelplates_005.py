...
filename = '/home/osama/HiWi/new-version/asm-2/3_pickle/RFR_steelplates_005.pkl'
...
if os.path.exists('/home/osama/HiWi/new-version/asm-2/3_pickle/RFR_steelplates_005.json'):
    with open('/home/osama/HiWi/new-version/asm-2/3_pickle/RFR_steelplates_005.json', 'r') as f:
        models = json.load(f)
    models["Model"]["Metrics"] = metrics
    with open('/home/osama/HiWi/new-version/asm-2/3_pickle/RFR_steelplates_005.json', 'w') as f:
