...
lr = Pipeline([
    ...
    ('classifier', RandomForestClassifier(n_estimators=20,max_depth=2,min_samples_split=2))])
...
import joblib
filename = '/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_032.pkl'
...
if os.path.exists('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_032.json'):
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_032.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_bank_032.json', 'w') as f:
