...
dt = RandomForestClassifier(n_estimators=20,max_depth=25)
seed = 25
y = df.IsBadBuy
...
import joblib
filename = '/home/sruthi/asm-2/asm-2/3_pickle/RFR_kick_021.pkl'
...
if os.path.exists('/home/sruthi/asm-2/asm-2/3_pickle/RFR_kick_021.json'):
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_kick_021.json', 'r') as f:
        models = json.load(f)
    models["Metrics"] = metrics
    with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_kick_021.json', 'w') as f:
