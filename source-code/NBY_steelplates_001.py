...
class BuildMLModel:
    ...
    def data_pre_processing(self):
        ...
        self.X_train_preprocessed = pd.concat([X_train_numeric_preprocessed],
                                              axis=1)
        self.X_test_preprocessed = pd.concat([X_test_numeric_preprocessed],
                                             axis=1)
        self.X_preprocessed_feature_names = X_non_categorical_preprocessed_feature_names
...
if __name__ == "__main__":
    ...
    # Info starts--------------------------------------
    task_name = "NBY_steelplates_001"
    spec_version = "1.0.2"
    use_case = "steel_plates"
    ...
    train_csv_name = "steel_plates_train_" + str(int(train_size * 100)) + ".csv"
    train_csv_path = os.path.join(data_base_path, train_csv_name)
    test_csv_name = "steel_plates_test_" + str(int((1 - train_size) * 100)) + ".csv"
    ...
    X_train_numeric_preprocessed = build_ml_model_obj.data_pre_processing()
    ...
    pickle_file_name = "NBY_steelplates_001"  # No need to put .pkl extension. pycaret save model automatically puts .pkl extension
    ...
    json_file_name = "NBY_steelplates_001.json"
