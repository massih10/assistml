...
filename = '/home/osama/HiWi/new-version/asm-2/3_pickle/DTR_steelplates_003.pkl'
...
if os.path.exists('/home/osama/HiWi/new-version/asm-2/3_pickle/DTR_steelplates_003.json'):
    with open('/home/osama/HiWi/new-version/asm-2/3_pickle/DTR_steelplates_003.json', 'r') as f:
        models = json.load(f)
    models["Model"]["Metrics"] = metrics
    with open('/home/osama/HiWi/new-version/asm-2/3_pickle/DTR_steelplates_003.json', 'w') as f:
