...
feature_map_nystroem = Nystroem(degree=50, gamma=1,coef0=0.001, kernel='laplacian',random_state=seed,n_components = 1131)
...
import joblib
filename = '/home/sruthi/asm-2/asm-2/3_pickle/SVM_kick_005.pkl'
...
# import os,json
# if os.path.exists('/home/sruthi/asm-2/asm-2/3_pickle/SVM_kick_005.json'):
#     with open('/home/sruthi/asm-2/asm-2/3_pickle/SVM_kick_005.json', 'r') as f:
#         models = json.load(f)
#     models["Metrics"] = metrics
#     with open('/home/sruthi/asm-2/asm-2/3_pickle/SVM_kick_005.json', 'w') as f:
