...
numerical_columns = ['VehYear','MMRAcquisitionAuctionAveragePrice','MMRAcquisitionAuctionCleanPrice','MMRAcquisitionRetailAveragePrice','MMRAcquisitonRetailCleanPrice','MMRCurrentAuctionAveragePrice','MMRCurrentAuctionCleanPrice','MMRCurrentRetailAveragePrice','MMRCurrentRetailCleanPrice','VehBCost']
...
import joblib
filename = '/home/sruthi/asm-2/asm-2/3_pickle/RFR_kick_006.pkl'
...
metrics['Test_time_per_unit'] = t/17358
...
# if os.path.exists('/home/sruthi/asm-2/asm-2/3_pickle/RFR_kick_006.json'):
#     with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_kick_006.json', 'r') as f:
#         models = json.load(f)
#     models["Metrics"] = metrics
#     with open('/home/sruthi/asm-2/asm-2/3_pickle/RFR_kick_006.json', 'w') as f:
#         json.dump(models, f, indent = 1)


pl = preprocess.named_transformers_['cat']
ohe = pl.named_steps['Woe']
